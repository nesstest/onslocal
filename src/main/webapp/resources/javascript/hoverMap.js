		...
		function executeQueryTask(evt){
			...
			if (area !== ""){
				if (levelname === "WD"){ 
					...
					if(ctryName == "Wales"){
						window.location.href=  'index.html?nav-search='+postcode+'&levelname=LAD&areaname='+areaname+'&areacode='+area+'&cn='+ctryName+'&cc='+ctryCode+'&markerenvelope='+xCoord+':'+yCoord+'&pcSearch=false'
					}
					else
					{
